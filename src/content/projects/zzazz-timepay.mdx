...
<ImageRow images={[
  { src: "/cs/zzazz-timepay-cash.png", alt: "TimePay — cash payment flow" },
  { src: "/cs/zzazz-timepay-credits.png", alt: "TimePay — TPC credit redemption flow" },
  { src: "/cs/zzazz-timepay-sponsored.png", alt: "TimePay — sponsored access: Get sponsored by [Brand]" }
]} />
...
![TPC credit loop — circular earn, store, redeem, earn cycle across product surfaces](/cs/zzazz-timepay-tpc-loop.png)

## The Access Experience

When a user encounters priced content, the access layer appears:
...
<ImageRow images={[
  { src: "/cs/zzazz-timepay-priced.png", alt: "Content is priced — access prompt appears" },
  { src: "/cs/zzazz-timepay-options.png", alt: "Three access paths displayed" },
  { src: "/cs/zzazz-timepay-sponsored-brand.png", alt: "Sponsored access with brand" },
  { src: "/cs/zzazz-timepay-unlocked.png", alt: "Access unlocked — content opens" }
]} />
