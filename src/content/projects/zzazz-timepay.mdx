...
year: "2025"
accentColor: "#F59E0B"
coverImage: "../../assets/images/projects/zzazz-timepay-cover.webp"
parentProject:
  title: "Zzazz.ai"
  slug: "zzazz-ai"
---
...
TimePay existed only as a concept when I joined — but the research was clear: users don't resist paying, they resist committing to an uncertain outcome. Price works as a quality signal until payment enters, then the same price becomes fear and friction. I turned the concept into the linchpin of the ecosystem: designed **three access paths** (cash, TPC credits, sponsored attention) matched to behavioural states, architected the **TPC earn-store-redeem credit loop**, shipped a **mobile-first native bottom sheet** at the point of impulse, and reframed the product from "buy content" to access that matches how people actually decide to spend.

<MetricTable metrics={[
  { value: "1.9% → 80–98%", label: "Users Reached" },
...
<video src="/cs/zzazz-timepay-video.mp4" autoplay loop muted playsinline style="width:100%;border-radius:12px;margin:8px 0" />
