...
function Hero() {
  ...
  return (<section id="about" aria-label="About Ashish Khoshya" style={{ minHeight: m ? "auto" : "100vh", display: "flex", flexDirection: "column", justifyContent: "center", paddingTop: m ? 100 : 140, paddingBottom: m ? 48 : 80, position: "relative", overflow: "hidden" }}>
    ...
    <Wrap style={{ position: "relative", zIndex: 1 }}>
      ...
      <p style={{ fontFamily: FB, fontSize: m ? 12 : 13, lineHeight: 1.65, color: t.muted, maxWidth: 540, marginTop: 10, opacity: ld ? 1 : 0, transition: "all 0.8s ease 0.75s" }}>Also picking up <span style={{ color: t.text, fontWeight: 500 }}>vibe coding</span> — learning to stitch frontend &amp; backend as the tools evolve. Not an expert yet, but building alongside the world.</p>
